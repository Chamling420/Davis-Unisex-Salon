...
export default function Login() {
  const { user, loginGoogle, loginGuest, loginEmail, signupEmail, loading } = useAuth();
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // AuthContext will handle redirect on state change
    } catch (err: any) {
      if (err.code === 'auth/invalid-credential') {
        setError('Invalid email or password. Please check your credentials or create an account if you do not have one.');
