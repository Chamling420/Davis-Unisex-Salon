...
export default function Footer() {
  return (
    <footer className="bg-slate-950 border-t border-blue-500/20 text-slate-400 py-16 text-[11px] uppercase tracking-[0.15em] leading-loose">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            <h3 className="text-slate-100 font-bold tracking-widest mb-8 border-b border-slate-800 pb-4 inline-block">Directory</h3>
            <ul className="space-y-4">
              <li><a href="/#services" className="hover:text-blue-500 transition-colors hover:pl-2 relative duration-300">Services</a></li>
              <li><a href="/#gallery" className="hover:text-blue-500 transition-colors hover:pl-2 relative duration-300">Gallery</a></li>
              <li><a href="/#about" className="hover:text-blue-500 transition-colors hover:pl-2 relative duration-300">About Us</a></li>
              <li><Link to="/book" className="hover:text-blue-500 transition-colors text-blue-500/80">Book Appointment</Link></li>
              <li><Link to="/login" className="hover:text-blue-500 transition-colors">Sign In</Link></li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-slate-100 font-bold tracking-widest mb-8 border-b border-slate-800 pb-4 inline-block">Contact</h3>
        ...
        <div className="border-t border-slate-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-[9px] text-slate-400 tracking-[0.2em]">
